...
<body>
    <header class="header">
        ...
        <div class="contactInfo">
            ...
            <!-- <label>Name: <?php echo htmlspecialchars($admin_username); ?></label>
            <label>ID: <?php echo htmlspecialchars($admin_user_id); ?></label> -->
        </div>
    </header>
    <div class="container">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    // Display the image
                                    $imagePath = !empty($row['EventImage']) ? $row['EventImage'] : 'path/to/placeholder.png';
                ...
                <div class="table_body">
                    <table>
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM event WHERE EventDateTime < NOW()";
                            $result = $conn->query($query);
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    ...
                                    // Display the image
                                    $imagePath = !empty($row['eventimage']) ? $row['eventimage'] : 'path/to/placeholder.png';
                                    echo "<td><img src='../../../uploads/{$imagePath}' alt='Event Image' width='50'></td>";

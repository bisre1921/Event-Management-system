...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO events (EventName, EventDescription, EventImage, EventDateTime, Location, Category, Status, WriterUsername) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    <body>
        <header class="header">
            ...
            <div class="contactInfo">
                <img class="AdminPhoto" src="../assets/adminUser.png" alt="Admin Photo">
                ...
                <ul class="navItems">
                    ...
                    <!-- <li>
                        <a class="comment" href="#">
                            <i class="fa fa-comments" style="--i:2"></i>
                        </a>
                        <span style="--g:2">Comment</span>
                    </li> -->
                    <li>
                        <a class="Expire" href="#">
                            <i class="fa fa-times-circle" style="--i:3"></i>
                        </a>
                        <span style="--g:3">Expire</span>
                    </li>
                    <li>
                        <a class="upcoming" href="#">
                            <i class="fa fa-spinner" style="--i:4"></i>
                        </a>
                        <span style="--g:4">Upcoming</span>
                    </li>
                    <li>
                        <a class="summary" href="#">
                            <i class="fa fa-pie-chart" aria-hidden="true" style="--i:5"></i>
                        </a>
                        <span style="--g:5">Summary</span>
                    </li>
                    <li>
                        <a class="logout" href="http://localhost/university-event-managment-final/front-end/HTML(PHP)/FrontPage.php">
                            <i class="fa fa-sign-out" aria-hidden="true" style="--i:6"></i>
                        </a>
                    ...
                    <div class="table_body">
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM events WHERE EventDateTime < NOW()";
                                $result = $conn->query($query);
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                    ...
                    <div class="metrics-box">
                        ...
                        <div id="metrics-container" class="metrics-container">
                            ...
                            $query = "
                                ...
                                FROM EventMetrics
                                INNER JOIN events ON eventmetrics.EventID = events.EventID
                            ";;
                            $result = $conn->query($query);

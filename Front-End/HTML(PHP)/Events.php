...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM events WHERE EventName LIKE '%$search%' ORDER BY EventDateTime DESC";
};
    ...
    <div class="event-container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // echo '<img src="../assets/background.png" alt="Event Image">'; // Replace with actual event image
